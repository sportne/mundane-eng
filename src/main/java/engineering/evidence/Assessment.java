...
public final class Assessment implements Model.Domain {
    public java.util.Map<String,String> changeGroups(){return java.util.Map.ofEntries(java.util.Map.entry("id","identity"),java.util.Map.entry("run","review-decisions"),java.util.Map.entry("disposition","review-decisions"),java.util.Map.entry("reviewer","review-decisions"),java.util.Map.entry("role","review-decisions"),java.util.Map.entry("reason","review-decisions"));}
    public Object schema(){return engineering.artifacts.Json.read(AssessmentSchema.JSON.getBytes(java.nio.charset.StandardCharsets.UTF_8));}
