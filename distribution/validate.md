...
build/maintained/mundanereq-validate examples/yaml/vaccine-monitoring
```
...
The [command contract](../specification/0007-validator-trial-contract-0.1.md) defines operations and exit codes.
