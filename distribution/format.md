...
build/maintained/mundanereq-format --check examples/yaml/vaccine-monitoring
```
...
The [command contract](../specification/0008-formatter-trial-contract-0.1.md) defines operations and exit codes.
