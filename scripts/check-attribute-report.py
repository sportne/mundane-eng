...
with tempfile.TemporaryDirectory(prefix='attribute-report-') as tmp:
 ...
 assert any('/schema.yaml#L' in href for href in parsed.links) and any('/source.mreq.yaml#L' in href for href in parsed.links) and any('/plan.yaml#L' in href for href in parsed.links)
