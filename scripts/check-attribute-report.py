...
with tempfile.TemporaryDirectory(prefix='attribute-report-') as tmp:
 ...
 for change in [lambda a:a.update(complete=False),lambda a:a.update(format='future'),lambda a:a['linked'].update(format='mundane-linked-0.1'),lambda a:a['coverage'][0].update(changedAttributes=[]),lambda a:a['coverage'][0].update(schemaChanged=False),lambda a:a['coverage'][0].update(changedFields=[]),lambda a:a['linked']['imports'][1]['artifact']['requirements'][0]['values']['attributes'].update(discipline='bad'),lambda a:a['linked']['imports'][1]['artifact']['attributeSchema']['definition'].update(format='future'),lambda a:a['linked']['imports'][1]['artifact']['requirements'][0]['locations']['attributes'].pop('discipline'),lambda a:a['linked']['imports'][1]['artifact']['attributeSchema']['source'].update(path='../bad'),lambda a:a['linked']['imports'][1]['artifact']['attributeSchema']['locations']['discipline']['end'].update(line=0)]:
