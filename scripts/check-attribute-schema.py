...
for schema_name,fixture in [('attribute-declaration-0.1.json','requirement-attributes.yaml'),('requirements-yaml-0.4.json','system.mreq.yaml')]:
...
for fixture in sorted((ROOT/'examples/attributes/medium').glob('*')):
    ...
    name='attribute-declaration-0.1.json' if fixture.name=='attribute-schema.yaml' else 'requirements-yaml-0.4.json'
