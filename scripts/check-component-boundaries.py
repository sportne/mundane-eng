...
with tempfile.TemporaryDirectory(prefix='component-boundary-') as directory:
    ...
    for component, forbidden in [('requirements','engineering.work.WorkMain'),
            ...
            ('artifacts','mundanereq.Interpreter'), ('architecture-model','engineering.domainsource.Source'), ('architecture-model','mundane.yaml.Yaml'), ('configuration-model','engineering.domainsource.Source'), ('safety-model','mundane.yaml.Yaml'), ('procedure-model','engineering.domainsource.Source'), ('evidence-model','mundane.yaml.Yaml'), ('software-model','engineering.domainsource.Source'), ('equipment-model','mundane.yaml.Yaml')]:
